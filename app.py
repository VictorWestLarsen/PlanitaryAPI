...
def db_seed():
    ...
    test_user = User(first_name='Hans',
                     last_name='Hansen',
                     email='test@test.dk',
                     password='password')
...
def super_simple():
    return jsonify("Hello from planetary api")
...
def retrieve_password(email: str):
    ...
    if user:
        msg = Message("Your planitary api password is " + user.password, sender="admin@planetary.com", recipients=[email])
        mail.send(msg)
...
def add_planet():
    ...
    if test:
        ...
        db.session.commit()
        return jsonify(message="Your planet has been added")
...
def remove_planet(planet_id:int):
    ...
    if planet:
        ...
        db.session.commit()
        return jsonify(message="You deletede a planet"), 202
    else:
        return jsonify(message="No planet with that ID exists")
